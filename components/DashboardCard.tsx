  ...
  return (
    ...
    >
      <div className="relative z-10 h-full p-4 flex flex-col justify-between">
        ...
        {/* <div
          className={`bg-black bg-opacity-70 bg- w-full absolute z-[10000] h-full py-2 duration-150 ease-in-out inset-0 flex flex-col gap-5 justify-center items-center dark:text-white text-black translate-y-full group-hover:translate-y-0`}
        >
          {hasView && (
            <TooltipProvider delayDuration={0}>
              <Tooltip>
